...
public class MySimpleDynamicScenarioSimulation extends Simulation{
	...
	public MySimpleDynamicScenarioSimulation(String aresources_path, String adbname, int seed, boolean useDerby) {
...
//		String[] containsAppliances = {"appl1"};
	...
	{	
		...
		MySimpleDynamicScenarioSimulation sim = new MySimpleDynamicScenarioSimulation(output_path, "SimpleStatic"+System.currentTimeMillis(), seed, useDerby);
  		try {
			sim.setup(false);
		} catch (Exception e) {
			e.printStackTrace();
