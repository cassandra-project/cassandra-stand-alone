...
//		this.simulationWorld = setupFaniTestScenario1_SimulationParams();
		this.simulationWorld = setupProjectDynamicDynamicScenario_SimulationParams();
		
		this.demographics = setupProjectDynamicDynamicScenario_DemographicData();
...
//		return  setupFaniTestScenario1_Installations(this.simulationWorld);
		return  setupProjectDynamicDynamicScenario_Installations(this.simulationWorld);
	}
	...
	private SimulationParams setupProjectDynamicDynamicScenario_SimulationParams()
	{
		String scenarioName = "DynamicScenario";
  		String responseType = "None"; 		// "None", "Optimal", "Normal", "Discrete", "Daily"
  	    String locationInfo ="Katerini";
  	    int numOfDays = 7; 						// duration
  	    int startDateDay = 3;
	    int startDateMonth = 7;
	    int startDateYear = 2014;
	    int mcruns = 1;
  		double co2 = 2; 
  		String setup = "dynamic"; 							// static, dynamic
	...
	private DemographicData setupProjectDynamicDynamicScenario_DemographicData()
	{
		...
		return new DemographicData("lala", "description", "type", numOfInstallations, instGen, personGen, personGen);
	}
